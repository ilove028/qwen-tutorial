...
const messages = [
    {
        ...
        你一次只能向用户提问一个参数。如果用户提供的信息不全，你需要反问他，让他提供没有提供的参数。如果参数收集完成，你要说：我已了解您的购买意向，请稍等。如果用户没有满意的参数,你要说: 有新品我们会尽快联系您。`,
    }
];
...
(async () => {
    while (!assistant_output.includes("我已了解您的购买意向") && !assistant_output.includes("有新品我们会尽快联系您")) {
